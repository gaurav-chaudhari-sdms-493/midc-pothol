...
export const PWAPrompt = () => {
  ...
  // Check if we are running standalone (already installed)
    ...
    <AnimatePresence>
      {showPrompt && (
        <motion.div
          ...
          exit={{ opacity: 0, y: 50 }}
          className="fixed bottom-20 md:bottom-6 left-4 right-4 md:left-auto md:right-6 z-[60] bg-white dark:bg-gray-800 rounded-xl shadow-2xl border border-gray-200 dark:border-gray-700 p-4 max-w-sm mx-auto md:mx-0"
        >
          <button 
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              ...
              <button
                ...
                className="w-full bg-govBlue hover:bg-govBlue-dark text-white text-sm font-medium py-2 rounded-lg flex items-center justify-center gap-2 transition-colors shadow-sm"
              >
